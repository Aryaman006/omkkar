...
const services = [
     {
    title: "Training",
    description: "Whether you’re a start-up or an established enterprise looking to upskill your team, Omkkar Innovations can help your workforce prepare for tomorrow through our revolutionary and outcome-centric cloud corporate training programs.Corporate Training Solutions for employees that guarantee higher ROIIncrease your business ROI without burdening your training budget with Omkkar Innovations customized employee training and development programs.Omkkar innovations provides live instructor led online and classroom training in information technology areas. The course curriculum has been created and curated by industry experts, and delivered live by instructors with the objective to ensure that once the course is completed, learners achieve deep expertise in the chosen technology",
    image: "/team3.jpg",
  },
   {
    title: "Technologies We Cover",
    description: "We deliver best-in-class corporate training for employees working at different levels on emerging technologies like Cloud, AI & ML, Big Data, Blockchain, etcOur team of expert trainers will empower your employees to upskill depending on the business needs in both Technical and Non-Technical space. Training has proven to be the way forward for career progression across verticals. It will also act as a motivating factor to retain talent within your organisationWe design bespoke training session to exactly meet your requirements and in turn help you drive productivity.We design bespoke training session to exactly meet your requirements and in turn help you drive productivity",
    image: "/tech.jpg",
  },
]
  ...
  return (
    <div className="font-sans mt-10">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
         <div
        className="absolute inset-0 bg-center bg-no-repeat bg-cover filter z-0"
        style={{ backgroundImage: `url('/website-bg.jpg')`, backgroundSize: '100%' }}
      ></div>
      ...
      <div className="absolute inset-0 bg-black opacity-50 z-10"></div>
        ...
        <div className="relative z-20 flex flex-col justify-center items-center h-full text-white text-center px-4">
          <h1 className="text-4xl md:text-5xl font-semibold">Omkkar Training</h1>
          <p className="mt-8">Omkkar Innovations / Omkkar Training</p>
        </div>
      </div>

      <section className="py-16 px-6 m-20 md:px-20 space-y-16">
