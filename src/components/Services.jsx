...
const services = [
  {
    ...
    icon: <FaLaptopCode size={60} className="logo" />,
    description:
  ...
  },
  {
    ...
    icon: <FaMobileAlt size={60} className="logo" />,
    description:
  ...
  {
    title: "UI & UX Design",
    icon: <FaPalette size={60} className="logo" />,
    description:
  ...
  },
  {
    ...
    icon: <FaBullhorn size={60} className="logo" />,
    description:
  ...
  },
  {
    ...
    icon: <FaPenNib size={60} className="logo" />,
    description:
  ...
  return (
    <section className="bg-[#f4f8ff] py-16 px-4">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-semibold text-[#091133] mb-12">Our Services</h2>
        <div className="grid grid-cols-1 px-12 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
           <div
  key={index}
  className="service-card rounded-2xl p-6 text-left shadow-md hover:shadow-lg transition duration-300"
>
  <div className="mb-4 icon transition-colors duration-300">{service.icon}</div>
